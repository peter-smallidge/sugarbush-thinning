...
<!-- such that the output (ssc) of year i is associated with growth in year i-1 -->
<!-- select the growth variables and year which is integer, set year = year -1 -->
<!-- filter to remove year = 2015 -->
